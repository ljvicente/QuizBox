		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>index.php/examination">Generate Examination</a>
					</li>
				</ul>
			...
			<div class="row-fluid">
				...
				<div class="box span8">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> List of Examinations</h2>
						<div class="box-icon">
							<!--
						  ...
						  <thead>
							...
							<?php if(isset($records)) : foreach($records as $row) : ?>
								<tr>
									...
									<td>
										<a href="<?php echo base_url() . 'index.php/examination/item/' . $row->examination_id;?>" style="cursor:pointer;" class="btn btn-primary"><i class="icon-edit icon-white"></i>Edit Items</a>
										<a id="<?php echo $row->examination_id;?>" style="cursor:pointer;" class="editbutton btn btn-info"><i class="icon-edit icon-white"></i> Rename</a>
										<a id="<?php echo $row->examination_id;?>" style="cursor:pointer;" class="deletebutton btn btn-danger"><i class="icon-trash icon-white"></i> </a>	
									</td>
								</tr>
								<?php endforeach;?>
				...
				<div class="span4">
					...
					<div class="box">
						<div class="box-header well" data-original-title>
							<h2><i class="icon-user"></i> Add Examination</h2>
						</div>
								...
								<table class="table">
									...
									<tr>
										<td>
											...
											<select id="no_of_choices" name="no_of_choices">
									...
									<tr>
										<td>
											<button type="submit" class="btn btn-success"><i class="icon-plus icon-white"></i> Add Examination</button>
										</td>
										<td>&nbsp;</td>
									</tr>
								</table>
