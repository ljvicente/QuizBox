		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>index.php/examination">Print Reports</a>
					</li>
				</ul>
			...
			<div class="row-fluid">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Printable Reports</h2>
						<div class="box-icon">
							<!--
					...
					<div class="box-content">
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  <th>Report Name <span title=".icon  .icon-triangle-ns " class="icon icon-triangle-ns"></span></th>
								  <th>Date <span title=".icon  .icon-triangle-ns " class="icon icon-triangle-ns"></span></th>
								  <th>&nbsp;</th>
							  </tr>
						  </thead>   
								<tr>
									...
									<td>2013-04-20</td>
									<td>
										<a id="" style="cursor:pointer;" class="btn btn-success"><i class="icon-edit icon-white"></i> View</a>	
										<a id="" style="cursor:pointer;" class="btn btn-info"><i class="icon-edit icon-white"></i> Edit</a>	
									</td>
								</tr>
								<tr>
