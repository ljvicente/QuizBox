		...
		<div class="row-fluid">
			...
			<div>
				<ul class="breadcrumb">
					...
					<li>
						<a href="<?php echo base_url();?>index.php/examination">Attendance Checker</a>
					</li>
				</ul>
			...
			<div class="row-fluid">
				...
				<div class="box span12">
					<div class="box-header well" data-original-title>
						<h2><i class="icon-user"></i> Attendance Checker</h2>
						<div class="box-icon">
							<!--
						...
						<table class="table table-striped table-bordered bootstrap-datatable datatable">
						  <thead>
							  <tr>
								  ...
								  <th>Student Name <span title=".icon  .icon-triangle-ns " class="icon icon-triangle-ns"></span></th>
								  <th>Batch Control Number <span title=".icon  .icon-triangle-ns " class="icon icon-triangle-ns"></span></th>
								  <th>&nbsp;</th>
							  </tr>
						  </thead>   
							...
							<tbody>
								...
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="10" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="10" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="9" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="9" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="8" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="8" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="7" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="7" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="1" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="1" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="2" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="2" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="3" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="3" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="4" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="4" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="5" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="5" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
								<tr>
									...
									<td>TS13-ASB-002 </td>
									<td>
										<a id="6" style="cursor:pointer;" class="btn btn-success btn-present"><i class="icon-edit icon-white"></i> Present</a>	
										<a id="6" style="cursor:pointer;" class="btn btn-danger btn-absent"><i class="icon-edit icon-white"></i> Absent</a>	
									</td>
								</tr>
							</tbody>
